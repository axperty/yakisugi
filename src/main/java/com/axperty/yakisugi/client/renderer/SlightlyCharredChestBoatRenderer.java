...
public class SlightlyCharredChestBoatRenderer extends AbstractBoatRenderer {
    ...
    public SlightlyCharredChestBoatRenderer(EntityRendererProvider.Context context) {
        super(context, Identifier.fromNamespaceAndPath(Yakisugi.MOD_ID, "textures/entity/chest_boat/slightly_charred.png"));
        this.waterPatchModel = new Model.Simple(context.bakeLayer(ModelLayers.BOAT_WATER_PATCH), texture -> RenderTypes.waterMask());
        this.model = new BoatModel(context.bakeLayer(ModelLayers.OAK_CHEST_BOAT));
    }
