...
public class CharredBoatRenderer extends EntityRenderer<CharredBoatEntity> {
    private final BoatModel boatModel;
    private final ResourceLocation texture;

    public CharredBoatRenderer(EntityRendererProvider.Context context, boolean hasChest) {
        super(context);
        ...
        this.texture = ResourceLocation.fromNamespaceAndPath(Yakisugi.MOD_ID, "textures/entity/" + (hasChest ? "chest_boat/" : "boat/") + "charred.png");
    }

    @Override
    public void render(CharredBoatEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(CharredBoatEntity entity) {
        return this.texture;
    }
}
