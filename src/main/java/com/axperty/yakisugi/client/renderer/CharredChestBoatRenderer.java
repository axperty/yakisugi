...
public class CharredChestBoatRenderer extends AbstractBoatRenderer {
    ...
    public CharredChestBoatRenderer(EntityRendererProvider.Context context) {
        super(context, Identifier.fromNamespaceAndPath(Yakisugi.MOD_ID, "textures/entity/chest_boat/charred.png"));
