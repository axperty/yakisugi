...
public class CharredChestBoatRenderer extends EntityRenderer<CharredChestBoatEntity> {
    private final ChestBoatModel boatModel;
    private final ResourceLocation texture;

    public CharredChestBoatRenderer(EntityRendererProvider.Context context) {
        super(context);
        ...
        this.texture = ResourceLocation.fromNamespaceAndPath(Yakisugi.MOD_ID, "textures/entity/chest_boat/charred.png");
    }

    @Override
    public void render(CharredChestBoatEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(CharredChestBoatEntity entity) {
        return this.texture;
    }
}
