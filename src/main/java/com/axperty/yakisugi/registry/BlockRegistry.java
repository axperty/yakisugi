...
public class BlockRegistry {
    ...
    public static final Block BAMBOO_CLADDING_WALL = registerBlock("bamboo_cladding_wall",
    ...
    public static final Block STRIPPED_BAMBOO_CLADDING_WALL = registerBlock("stripped_bamboo_cladding_wall",
            new StrippedBambooCladdingWallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BAMBOO_PLANKS).noOcclusion()));

    // Tatami Block
    public static final Block TATAMI_BLOCK = registerBlock("tatami_block",
            new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_WOOL).sound(SoundType.WOOL)));

    // Tatami Mat
    public static final Block TATAMI_MAT = registerBlock("tatami_mat",
    ...
    public static final Block PAPER_LANTERN_CHERRY = registerBlock("paper_lantern_cherry",
            new PaperLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).sound(SoundType.WOOL).noOcclusion().lightLevel(state -> 7)));

    public static final Block PAPER_LANTERN_MOUNT_FUJI = registerBlock("paper_lantern_mount_fuji",
            new PaperLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).sound(SoundType.WOOL).noOcclusion().lightLevel(state -> 7)));
    ...
    // Aged Stone Wall
    public static final Block AGED_STONE_WALL = registerBlock("aged_stone_wall",
    ...
    public static final Block AGED_STONE_PRESSURE_PLATE = registerBlock("aged_stone_pressure_plate",
    ...
    // Aged Stone Button
    public static final Block AGED_STONE_BUTTON = registerBlock("aged_stone_button",
    ...
    // Aged Stone Stairs
    public static final Block AGED_STONE_STAIRS = registerBlock("aged_stone_stairs",
            new StairBlock(AGED_STONE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).sound(SoundType.DEEPSLATE)));
    ...
    // Aged Stone Lantern
    public static final Block AGED_STONE_LANTERN = registerBlock("aged_stone_lantern",
    ...
    public static final Block AGED_STONE_LANTERN_TOP = registerBlock("aged_stone_lantern_top",
    ...
    public static final Block POLISHED_AGED_STONE = registerBlock("polished_aged_stone",
            new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE).explosionResistance(6.0f)));

    // Polished Aged Stone Wall
    public static final Block POLISHED_AGED_STONE_WALL = registerBlock("polished_aged_stone_wall",
            new WallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COBBLESTONE_WALL).explosionResistance(6.0f)));

    // Polished Aged Stone Pressure Plate
    public static final Block POLISHED_AGED_STONE_PRESSURE_PLATE = registerBlock("polished_aged_stone_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_PRESSURE_PLATE).sound(SoundType.DEEPSLATE).explosionResistance(6.0f)));

    // Polished Aged Stone Button
    public static final Block POLISHED_AGED_STONE_BUTTON = registerBlock("polished_aged_stone_button",
            new ButtonBlock(BlockSetType.STONE, 20, BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BUTTON).sound(SoundType.DEEPSLATE).explosionResistance(6.0f)));

    // Polished Aged Stone Stairs
    public static final Block POLISHED_AGED_STONE_STAIRS = registerBlock("polished_aged_stone_stairs",
            new StairBlock(POLISHED_AGED_STONE.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).sound(SoundType.DEEPSLATE)));

    // Polished Aged Stone Slab
    public static final Block POLISHED_AGED_STONE_SLAB = registerBlock("polished_aged_stone_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).sound(SoundType.DEEPSLATE)));

    // Polished Aged Stone Lantern
    public static final Block POLISHED_AGED_STONE_LANTERN = registerBlock("polished_aged_stone_lantern",
            new AgedStoneLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).sound(SoundType.DEEPSLATE).noOcclusion()));

    // Polished Aged Stone Lantern Top
    public static final Block POLISHED_AGED_STONE_LANTERN_TOP = registerBlock("polished_aged_stone_lantern_top",
            new AgedStoneLanternTopBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).sound(SoundType.DEEPSLATE).noOcclusion().lightLevel(AgedStoneLanternTopBlock::getLightEmission)));

    // Aged Stone Tsukubai
    public static final Block AGED_STONE_TSUKUBAI = registerBlock("aged_stone_tsukubai",
    ...
    public static final Block POLISHED_AGED_STONE_TSUKUBAI = registerBlock("polished_aged_stone_tsukubai",
            new TsukubaiBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).sound(SoundType.DEEPSLATE).explosionResistance(6.0f).noOcclusion()));

    // Slightly Charred Planks
    public static final Block SLIGHTLY_CHARRED_PLANKS = registerBlock("slightly_charred_planks",
            new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)
                    .sound(SoundType.WOOD)
                    .explosionResistance(6.0f)));

    // Slightly Charred Stairs
    public static final Block SLIGHTLY_CHARRED_STAIRS = registerBlock("slightly_charred_stairs",
            new StairBlock(SLIGHTLY_CHARRED_PLANKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_STAIRS).explosionResistance(6.0f)));

    // Slightly Charred Slab
    public static final Block SLIGHTLY_CHARRED_SLAB = registerBlock("slightly_charred_slab",
            new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SLAB).explosionResistance(6.0f)));

    // Slightly Charred Fence
    public static final Block SLIGHTLY_CHARRED_FENCE = registerBlock("slightly_charred_fence",
            new FenceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_FENCE).explosionResistance(6.0f)));

    // Slightly Charred Fence Gate
    public static final Block SLIGHTLY_CHARRED_FENCE_GATE = registerBlock("slightly_charred_fence_gate",
    ...
    public static final Block SLIGHTLY_CHARRED_PRESSURE_PLATE = registerBlock("slightly_charred_pressure_plate",
    ...
    public static final Block SLIGHTLY_CHARRED_BUTTON = registerBlock("slightly_charred_button",
    ...
    public static final Block SLIGHTLY_CHARRED_TRAPDOOR = registerBlock("slightly_charred_trapdoor",
    ...
    public static final Block SLIGHTLY_CHARRED_SIGN = register("slightly_charred_sign",
    ...
    public static final Block SLIGHTLY_CHARRED_WALL_SIGN = register("slightly_charred_wall_sign",
    ...
    public static final Block SLIGHTLY_CHARRED_HANGING_SIGN = register("slightly_charred_hanging_sign",
    ...
    public static final Block SLIGHTLY_CHARRED_WALL_HANGING_SIGN = register("slightly_charred_wall_hanging_sign",
    ...
    public static final Block CHARRED_STAIRS = registerBlock("charred_stairs",
            new StairBlock(CHARRED_PLANKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_STAIRS).explosionResistance(6.0f)));
    ...
    public static final Block CHARRED_WALL_HANGING_SIGN = register("charred_wall_hanging_sign",
    ...
    // Charred Cabinet
    public static final Block CHARRED_CABINET = register("charred_cabinet",
            new CabinetBlock(Block.Properties.ofFullCopy(Blocks.BARREL).explosionResistance(6.0f)));

    // Slightly Charred Cabinet
    public static final Block SLIGHTLY_CHARRED_CABINET = register("slightly_charred_cabinet",
            new CabinetBlock(Block.Properties.ofFullCopy(Blocks.BARREL).explosionResistance(6.0f)));

    // Floor Bed
    // also changing this one for future release
//    public static final Block FLOOR_BED = registerBlock("floor_bed",
//            new FloorBedBlock(net.minecraft.world.item.DyeColor.BROWN, BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_BED).noOcclusion()));
    ...
    private static <T extends Block> T registerBlock(String name, T block) {
        register(name, new BlockItem(block, new Item.Properties()), BuiltInRegistries.ITEM);
    ...
    private static <T> T register(String name, T value, Registry<? super T> registry) {
        return Registry.register(registry, ResourceLocation.fromNamespaceAndPath(Yakisugi.MOD_ID, name), value);
    }
